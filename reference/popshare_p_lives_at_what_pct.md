...
- atleast_not_exact:
  ...
  if atleast_not_exact = TRUE and astext = TRUE, answer is like "10% of
  places account for at least 50% of the total population" and if
  atleast_not_exact = FALSE, answer is like
