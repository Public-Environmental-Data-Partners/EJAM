...
An object of class `data.frame` with 58 rows and 26 columns.
...
Also see [Census
info](https://www.census.gov/programs-surveys/decennial-census/decade/2020/planning-management/release/2020-island-areas-data-products.html)

column names:

c('statename', 'FIPS.ST', 'ST', 'ftpname', 'REGION',

'is.usa.plus.pr', 'is.usa', 'is.state', 'is.contiguous.us',
'is.island.areas',
