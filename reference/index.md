...
- [`EJAM`](https://ejanalysis.github.io/EJAM/reference/EJAM.md)
  [`EJAM-package`](https://ejanalysis.github.io/EJAM/reference/EJAM.md)
...
- [`ejam2barplot_indicators()`](https://ejanalysis.github.io/EJAM/reference/ejam2barplot_indicators.md)
...
- [`ejam2barplot_distances()`](https://ejanalysis.github.io/EJAM/reference/ejam2barplot_distances.md)
  ...
  one radius
- [`ejam2histogram()`](https://ejanalysis.github.io/EJAM/reference/ejam2histogram.md)
...
- [`ejam2shapefile()`](https://ejanalysis.github.io/EJAM/reference/ejam2shapefile.md)
...
- [`sitepoints_from_any()`](https://ejanalysis.github.io/EJAM/reference/sitepoints_from_any.md)
  [`sitepoints_from_anything()`](https://ejanalysis.github.io/EJAM/reference/sitepoints_from_any.md)
...
- [`latlon_from_anything()`](https://ejanalysis.github.io/EJAM/reference/latlon_from_anything.md)
  : Get lat/lon flexibly - from file, data.frame, data.table, or lat/lon
  vectors
- [`latlon_from_address_table()`](https://ejanalysis.github.io/EJAM/reference/latlon_from_address_table.md)
...
- [`latlon_from_shapefile()`](https://ejanalysis.github.io/EJAM/reference/latlon_from_shapefile.md)
...
- [`lat_alias`](https://ejanalysis.github.io/EJAM/reference/lat_alias.md)
...
- [`regids_valid()`](https://ejanalysis.github.io/EJAM/reference/regids_valid.md)
...
- [`frs_from_programid()`](https://ejanalysis.github.io/EJAM/reference/frs_from_programid.md)
  : Use EPA Program ID to see FRS Facility Registry Service data on
  those EPA-regulated sites
- [`frs_from_sitename()`](https://ejanalysis.github.io/EJAM/reference/frs_from_sitename.md)
  : Use site name text search to see FRS Facility Registry Service data
  on those EPA-regulated sites
- [`frs`](https://ejanalysis.github.io/EJAM/reference/frs.md) : frs
  (DATA) EPA Facility Registry Service table of regulated sites
...
- [`naics_is.valid()`](https://ejanalysis.github.io/EJAM/reference/naics_is.valid.md)
...
- [`naics_url_of_code()`](https://ejanalysis.github.io/EJAM/reference/naics_url_of_code.md)
...
- [`naics2children()`](https://ejanalysis.github.io/EJAM/reference/naics2children.md)
...
- [`testinput_naics`](https://ejanalysis.github.io/EJAM/reference/testinput_naics.md)
...
- [`NAICS`](https://ejanalysis.github.io/EJAM/reference/NAICS.md) :
  ...
  for each
- [`SIC`](https://ejanalysis.github.io/EJAM/reference/SIC.md) : SIC
  (DATA) named list of all SIC code numbers and category name for each
...
- [`testinput_program_name`](https://ejanalysis.github.io/EJAM/reference/testinput_program_name.md)
  : testinput_program_name dataset
- [`testinput_program_sys_id`](https://ejanalysis.github.io/EJAM/reference/testinput_program_sys_id.md)
...
- [`latlon_from_program()`](https://ejanalysis.github.io/EJAM/reference/latlon_from_program.md)
...
- [`testinput_mact`](https://ejanalysis.github.io/EJAM/reference/testinput_mact.md)
...
- [`mact_table`](https://ejanalysis.github.io/EJAM/reference/mact_table.md)
  ...
  description)
- [`latlon_from_mactsubpart()`](https://ejanalysis.github.io/EJAM/reference/latlon_from_mactsubpart.md)
...
- [`shapefile_clean()`](https://ejanalysis.github.io/EJAM/reference/shapefile_clean.md)
  ...
  (CRS)
- [`shape_buffered_from_shapefile()`](https://ejanalysis.github.io/EJAM/reference/shape_buffered_from_shapefile.md)
...
- [`shapes_blockgroups_from_bgfips()`](https://ejanalysis.github.io/EJAM/reference/shapes_blockgroups_from_bgfips.md)
  : Get blockgroups boundaries, via API, to map them
- [`shape2zip()`](https://ejanalysis.github.io/EJAM/reference/shape2zip.md)
...
- [`fips2name()`](https://ejanalysis.github.io/EJAM/reference/fips2name.md)
  : FIPS - Get county or state names from county or state FIPS codes
- [`fips2countyfips()`](https://ejanalysis.github.io/EJAM/reference/fips2countyfips.md)
...
- [`latlon_from_fips()`](https://ejanalysis.github.io/EJAM/reference/latlon_from_fips.md)
  : get approx centroid of each fips census unit
- [`fips2pop()`](https://ejanalysis.github.io/EJAM/reference/fips2pop.md)
...
- [`counties_as_sites()`](https://ejanalysis.github.io/EJAM/reference/counties_as_sites.md)
  : FIPS - Analyze US Counties as if they were sites, to get summary
  indicators summary for each county
- [`fips_counties_from_statefips()`](https://ejanalysis.github.io/EJAM/reference/fips_counties_from_statefips.md)
  : FIPS - Get ALL county fips in specified states
- [`fips_counties_from_state_abbrev()`](https://ejanalysis.github.io/EJAM/reference/fips_counties_from_state_abbrev.md)
  : FIPS - Get ALL county fips in specified states
- [`fips_counties_from_statename()`](https://ejanalysis.github.io/EJAM/reference/fips_counties_from_statename.md)
  : FIPS - Get ALL county fips in specified states
...
- [`shapes_counties_from_countyfips()`](https://ejanalysis.github.io/EJAM/reference/shapes_counties_from_countyfips.md)
  : Get Counties boundaries via API, to map them
- [`acs_bycounty()`](https://ejanalysis.github.io/EJAM/reference/acs_bycounty.md)
  : download ACS 5year data from Census API, at County resolution
- [`plot_bycounty()`](https://ejanalysis.github.io/EJAM/reference/plot_bycounty.md)
...
- [`states_shapefile`](https://ejanalysis.github.io/EJAM/reference/states_shapefile.md)
  ...
  (facility/site).
- [`states_as_sites()`](https://ejanalysis.github.io/EJAM/reference/states_as_sites.md)
  : FIPS - Analyze US States as if they were sites, to get summary
  indicators summary
- [`fips_state_from_state_abbrev()`](https://ejanalysis.github.io/EJAM/reference/fips_state_from_state_abbrev.md)
  : FIPS - Get state fips for each state abbrev
- [`fips_state_from_statename()`](https://ejanalysis.github.io/EJAM/reference/fips_state_from_statename.md)
  : FIPS - Get state fips for each state name
- [`fips_states_in_eparegion()`](https://ejanalysis.github.io/EJAM/reference/fips_states_in_eparegion.md)
  : FIPS - Get state fips for all States in EPA Region(s)
- [`fips2statename()`](https://ejanalysis.github.io/EJAM/reference/fips2statename.md)
...
- [`fips2statefips()`](https://ejanalysis.github.io/EJAM/reference/fips2statefips.md)
...
- [`indexpoints()`](https://ejanalysis.github.io/EJAM/reference/indexpoints.md)
  ...
  lat,lon
- [`indexfrs()`](https://ejanalysis.github.io/EJAM/reference/indexfrs.md)
  : Utility to create an efficient quadtree spatial index of
  EPA-regulated facility locations
- [`convert_units()`](https://ejanalysis.github.io/EJAM/reference/convert_units.md)
...
- [`bgej`](https://ejanalysis.github.io/EJAM/reference/bgej.md) : bgej
  (DATA) Summary Indexes for Census blockgroups
...
- [`avg.in.us`](https://ejanalysis.github.io/EJAM/reference/avg.in.us.md)
...
- [`modelDoaggregate`](https://ejanalysis.github.io/EJAM/reference/modelDoaggregate.md)
...
- [`acs_table_info()`](https://ejanalysis.github.io/EJAM/reference/acs_table_info.md)
  : utility to download and print some info about each variable in each
  ACS 5yr table
- [`acsendyear()`](https://ejanalysis.github.io/EJAM/reference/acsendyear.md)
  : check which ACS 5-year survey is available, per EJAM metadata or
  guessed via published or typical schedules
...
- [`popshare_p_lives_at_what_pct()`](https://ejanalysis.github.io/EJAM/reference/popshare_p_lives_at_what_pct.md)
  ...
  of population
- [`distance_trends()`](https://ejanalysis.github.io/EJAM/reference/distance_trends.md)
...
- [`distance_by_group_plot()`](https://ejanalysis.github.io/EJAM/reference/distance_by_group_plot.md)
  ...
  [`plot_distance_cdf_by_group()`](https://ejanalysis.github.io/EJAM/reference/distance_by_group_plot.md)
...
- [`plot_distance_mean_by_group()`](https://ejanalysis.github.io/EJAM/reference/plot_distance_mean_by_group.md)
  [`plot_distance_by_group()`](https://ejanalysis.github.io/EJAM/reference/plot_distance_mean_by_group.md)
...
- [`map2browser()`](https://ejanalysis.github.io/EJAM/reference/map2browser.md)
...
- [`mapfastej_counties()`](https://ejanalysis.github.io/EJAM/reference/mapfastej_counties.md)
  : Map - County polygons / boundaries - Create leaflet or static map of
  results of analysis
- [`map_counties_in_state()`](https://ejanalysis.github.io/EJAM/reference/map_counties_in_state.md)
...
- [`map_blockgroups_over_blocks()`](https://ejanalysis.github.io/EJAM/reference/map_blockgroups_over_blocks.md)
...
- [`plot_lorenz_popcount_by_site()`](https://ejanalysis.github.io/EJAM/reference/plot_lorenz_popcount_by_site.md)
...
- [`ejam2barplot_areafeatures()`](https://ejanalysis.github.io/EJAM/reference/ejam2barplot_areafeatures.md)
  : barplot of summary stats on special areas and features at the sites
- [`plot_barplot_ratios_ez()`](https://ejanalysis.github.io/EJAM/reference/plot_barplot_ratios_ez.md)
...
- [`plot_boxplot_pctiles()`](https://ejanalysis.github.io/EJAM/reference/plot_boxplot_pctiles.md)
  ...
  indicators
- [`plot_ridgeline_ratios_ez()`](https://ejanalysis.github.io/EJAM/reference/plot_ridgeline_ratios_ez.md)
  : Make ridgeline plot of ratios of residential population percentage
  to its average
- [`plot_ridgeline_ratios()`](https://ejanalysis.github.io/EJAM/reference/plot_ridgeline_ratios.md)
  : Make ridgeline plot of ratios of residential population percentage
  to its average
...
- [`distance_by_group_plot()`](https://ejanalysis.github.io/EJAM/reference/distance_by_group_plot.md)
  ...
  [`plot_distance_cdf_by_group()`](https://ejanalysis.github.io/EJAM/reference/distance_by_group_plot.md)
  : Each groups distribution of distances
- [`plot_demogshare_by_distance()`](https://ejanalysis.github.io/EJAM/reference/plot_demogshare_by_distance.md)
  : plot_demogshare_by_distance - work in progress
- [`plot_lorenz_distance_by_dcount()`](https://ejanalysis.github.io/EJAM/reference/plot_lorenz_distance_by_dcount.md)
...
- [`testdata()`](https://ejanalysis.github.io/EJAM/reference/testdata.md)
  ...
  from EJAM functions
- [`testdatafolder()`](https://ejanalysis.github.io/EJAM/reference/testdatafolder.md)
...
- [`testshapes_2`](https://ejanalysis.github.io/EJAM/reference/testshapes_2.md)
  : testshapes_2 dataset

### Examples of Inputs (Census units by FIPS)

- [`testinput_fips_mix`](https://ejanalysis.github.io/EJAM/reference/testinput_fips_mix.md)
  : testinput_fips_mix dataset
- [`testinput_fips_states`](https://ejanalysis.github.io/EJAM/reference/testinput_fips_states.md)
  : testinput_fips_states dataset
- [`testinput_fips_counties`](https://ejanalysis.github.io/EJAM/reference/testinput_fips_counties.md)
  : testinput_fips_counties dataset
- [`testinput_fips_cities`](https://ejanalysis.github.io/EJAM/reference/testinput_fips_cities.md)
  : testinput_fips_cities dataset
- [`testinput_fips_tracts`](https://ejanalysis.github.io/EJAM/reference/testinput_fips_tracts.md)
  : testinput_fips_tracts dataset
- [`testinput_fips_blockgroups`](https://ejanalysis.github.io/EJAM/reference/testinput_fips_blockgroups.md)
...
- [`testpoints_n()`](https://ejanalysis.github.io/EJAM/reference/testpoints_n.md)
  : Random points in USA - average resident, facility, BG, block, or
  square mile
- [`testpoints_5`](https://ejanalysis.github.io/EJAM/reference/testpoints_5.md)
...
- [`testpoints_1000`](https://ejanalysis.github.io/EJAM/reference/testpoints_1000.md)
  : test points data.frame with columns sitenumber, lat, lon
- [`testpoints_10000`](https://ejanalysis.github.io/EJAM/reference/testpoints_10000.md)
  : test points data.frame with columns sitenumber, lat, lon
- [`testinput_address_table`](https://ejanalysis.github.io/EJAM/reference/testinput_address_table.md)
  : datasets for trying address-related functions

### Examples of Inputs (Points by regulated facility)

- [`testinput_registry_id`](https://ejanalysis.github.io/EJAM/reference/testinput_registry_id.md)
...
- [`testinput_naics`](https://ejanalysis.github.io/EJAM/reference/testinput_naics.md)
  : testinput_naics dataset
- [`testinput_sic`](https://ejanalysis.github.io/EJAM/reference/testinput_sic.md)
...
- [`testoutput_ejamit_10pts_1miles`](https://ejanalysis.github.io/EJAM/reference/testoutput_ejamit_10pts_1miles.md)
  : test output of ejamit()
- [`testoutput_ejamit_100pts_1miles`](https://ejanalysis.github.io/EJAM/reference/testoutput_ejamit_100pts_1miles.md)
  : test output of ejamit()
- [`testoutput_ejamit_1000pts_1miles`](https://ejanalysis.github.io/EJAM/reference/testoutput_ejamit_1000pts_1miles.md)
  : test output of ejamit()
- [`testoutput_ejamit_shapes_2`](https://ejanalysis.github.io/EJAM/reference/testoutput_ejamit_shapes_2.md)
  : testoutput_ejamit_shapes_2 dataset
- [`testoutput_ejamit_fips_cities`](https://ejanalysis.github.io/EJAM/reference/testoutput_ejamit_fips_cities.md)
...
- [`names_d`](https://ejanalysis.github.io/EJAM/reference/names_d.md) :
