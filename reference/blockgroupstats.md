...
- During 2025, EJAM used EPA environmental indicators along with
  population indicators derived from 2018-2022 ACS data. Each year this
  should be re-created as for the latest version.
