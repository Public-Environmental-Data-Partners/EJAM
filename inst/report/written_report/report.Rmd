...
The analysis used the [EJAM tool](https://ejanalysis.org/ejamdocs) and EJScreen version
...
The `r EJAM:::global_or_param(".app_title")` (EJAM) was used to develop this analysis. This tool is a user-friendly web app that can summarize residential population and environmental conditions for any list of places in the nation.
