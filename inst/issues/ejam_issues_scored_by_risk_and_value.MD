...
**Total open issues:** 141  |  **Generated:** 2026-08-23  |  **Source:** Live GitHub REST API open issues (Public-Environmental-Data-Partners/EJAM)
...
| **HIGH Cost**<br>cost ≥ median | **D — WORST CANDIDATES**<br>31 issues | **B — OK Candidates**<br>50 issues |
...
- [#268](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/268) — Uploading a file failing intermittently when live app hosted using AWS with load balancing
...
| [268](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/268) | Uploading a file failing intermittently when live app hosted using AWS… | 2 (🔵 Low) | 11 (🟩🟦 High) | v3.2022.2 | — | BUG, Affects Web App |
...
| [555](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/555) | Saved-results fixtures are macOS-specific: the 4 comparisons fail on L… | 4 (🟡 Medium) | 12 (🟩🟦 High) | v4 | PRIORITY MEDIUM | BUG, test |
| [560](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/560) | Four NAICS web-scrape tests fail when naics.com blocks a CI runner (se… | 4 (🟡 Medium) | 11 (🟩🟦 High) | v4 | — | BUG, Affects R users only - NOT web app users |
...
| [511](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/511) | CI runs only on PRs into main: development and deploy PRs get no check… | 4 (🟡 Medium) | 7 (🟦 Medium) | v4 | PRIORITY MEDIUM | test, Affects Web App |
| [510](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/510) | Smoke-test PDF generation in the built image and after deploy (prod PD… | 4 (🟡 Medium) | 7 (🟦 Medium) | v4 | PRIORITY MEDIUM | test, Affects Web App |
...
| [26](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/26) | Create LongReport (quarto/word doc/TSD) Settings Panel | 4 (🟡 Medium) | 5 (🟦 Medium) | NA | PRIORITY MEDIUM | LongReport_output, rank:D-defer |
| [33](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/33) | Move HTML, CSS, and Javascript code into appropriate external files | 5 (🟡 Medium) | 5 (🟦 Medium) | NA | PRIORITY MEDIUM | refactor, server, rank:D-defer |
| [80](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/80) | make latlon_from_naics() and other naics-related functions consistent … | 6 (🟡 Medium) | 5 (🟦 Medium) | NA | PRIORITY LOW | refactor, Affects R users only - NOT web app users, rank:D-defer |
| [77](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/77) | MODULE: Point layer MODULE (specify URL of service with point data) | 6 (🟡 Medium) | 5 (🟦 Medium) | NA | PRIORITY MEDIUM | refactor, server, rank:D-defer |
| [75](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/75) | "Schools Counter" functionality needed (to count schools or other feat… | 6 (🟡 Medium) | 5 (🟦 Medium) | NA | PRIORITY MEDIUM | shapefile-related, refactor, distance-related, rank:D-defer |
| [84](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/84) | enable an Add Data tool or otherwise harmonize with geoplatform, ejscr… | 8 (🟠 High) | 5 (🟦 Medium) | NA | PRIORITY LOW | shapefile-related, Affects Web App, rank:D-defer |
| [57](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/57) | Enable analysis of VERY large numbers of points - test limits and code… | 8 (🟠 High) | 5 (🟦 Medium) | NA | PRIORITY MEDIUM | tasklist, speed / performance (see #226), rank:D-defer |
...
| [32](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/32) | *** MOVE CODE OUT OF SERVER and app_ui | 11 (⛔ Very High) | 5 (🟦 Medium) | NA | PRIORITY MEDIUM | refactor, tasklist, server, rank:D-defer |
...
| [581](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/581) | Analysis of 2 or more tract FIPS codes never completes in the web app … | 4 (🟡 Medium) | 2 (⬜ Low) | NA | — |  |
| [536](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/536) | redo list of URLs in url_package() documentation | 4 (🟡 Medium) | 2 (⬜ Low) | v4 | PRIORITY LOW | documentation, refactor, Affects R users only - NOT web app users |
...
| [585](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/585) | CI: 'Quick install check' intermittently hangs to its 60-minute timeou… | 4 (🟡 Medium) | 0 (⬜ Very Low) | NA | — |  |
| [584](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/584) | Speed/ETA calibration: work deliberately scoped out of #515 | 4 (🟡 Medium) | 0 (⬜ Very Low) | v4 | — |  |
...
| A | [268](https://github.com/Public-Environmental-Data-Partners/EJAM/issues/268) | 2 | 11 | v3.2022.2 | — | Uploading a file failing intermittently when live app hosted using AWS w… |
