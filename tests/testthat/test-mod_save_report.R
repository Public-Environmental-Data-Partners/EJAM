...
test_that("draft save-report module server works when present", {
  skip_if_not(exists("mod_save_report_server"), message = "draft save-report module server is not present")
...
test_that("module ui works", {
  skip_if_not(exists("mod_save_report_ui"), message = "draft save-report module UI is not present")
