...
For example, this opens the hosted app pre-loaded with two counties (two sites):
    ...
    https://ejanalysis.com/ejamapp?fips=10001,10003

and this pre-loads two points with a 3-mile radius:

    https://ejanalysis.com/ejamapp?lat=33,34&lon=-112,-114&radius=3
...
the EJAM app at `?handoff=<token>` (e.g. `https://ejanalysis.com/ejamapp?handoff=<token>`);
