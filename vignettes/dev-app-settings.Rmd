...
Most of what you might want to do is shown in documentation showing examples of using the `ejamapp()` function. This article is only need if you want even more detail. First reading the `ejamapp()` reference info is recommended before reading any of the details below.
