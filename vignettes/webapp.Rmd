...
Note this is different than running a simple shiny app that is not also a package via the [golem](https://golemverse.org/) package. You should use the EJAM package function `ejamapp()` or `run_app()` not `shiny::runApp()`.
