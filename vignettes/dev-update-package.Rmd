...
code_reponame_url <- EJAM::url_package(get_full_url = T)   
# "https://github.com/OWNER/REPONAME"

# docs_reponame_with_owner <- EJAM::url_package('docs')# "OWNER/REPONAME"# does not make sense to have partial url for docs website
