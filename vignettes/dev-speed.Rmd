...
scenario_speeds <- EJAM:::speedtest_runtime_scenarios(
  detailed_csv = "data-raw/Analysis_timing_results_runtime_scenarios.csv",
  point_counts = c(1, 2, 10, 100),
  point_radii = c(1, 3.106856, 5),
  fips_counts = c(1, 3, 25),
  shapefile_counts = c(1, 3, 25)
)
