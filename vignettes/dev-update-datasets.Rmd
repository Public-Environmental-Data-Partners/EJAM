...
- Datasets stored within the EJAM package (.rda files): [Documentation](../reference/index.html#datasets-with-indicators-raw-data-means-percentiles-) and [access to data files](https://github.com/ejanalysis/EJAM/tree/main/data)

- Datasets used by EJAM but stored separately (large .arrow files): [Documentation](../reference/index.html#datasets-with-indicators-raw-data-means-percentiles-) and [access to data files](https://github.com/ejanalysis/ejamdata/tree/main/data)
