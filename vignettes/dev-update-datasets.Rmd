...
[access to package data files](`r paste0(EJAM::url_package(get_full_url = TRUE), "/tree/main/data")`)
...
[access to the large data files](`r paste0(EJAM::url_package(type = "data", get_full_url = TRUE), "/tree/main/data")`)
