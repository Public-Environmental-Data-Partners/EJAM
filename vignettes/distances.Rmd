...
as shown in the section on `plot_blocks_nearby()` and details of blocks near one
site.
...
```{r plot_blocks_nearby2, fig.cap="Example of using plot_blocks_nearby() to see a map of the blockpoints near a site", eval=TRUE, echo=TRUE, fig.height=5, fig.width=5}
...
```{r, doplotblocksnotshowoutput, fig.cap="Map very high density area with 4,596 blocks near the site, via plot_blocks_nearby()", eval=TRUE, echo=FALSE}
# radius <- 3
sitepoints <- testpoints_100
...
```{r, doplotblocksnotshowoutput_lowdensity, fig.cap="Map very low density area with 11 blocks near the site, via plot_blocks_nearby()", eval=TRUE, echo=FALSE}
