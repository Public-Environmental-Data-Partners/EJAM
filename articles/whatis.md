...
through version 2.32.6 in September 2025 was still using that same
dataset.

EJAM version 2.4.0 (released December 2025) is based on American
Community Survey (ACS) data representing the five-year period of
2019-2023 (released by the Census Bureau 2024-12-12). The ACS data are
