...
- Bug fixes:
  ...
  - Fixed bug affecting geocoding in
    [`names2fips()`](https://ejanalysis.github.io/EJAM/reference/name2fips.md)
...
- Added (strong) recommendation that you obtain a Census API key, in the
  ...
  package](https://ejanalysis.github.io/EJAM/articles/installing.html).
...
- Hosting:
  ...
  - Added example of using
    [`api_run()`](https://ejanalysis.github.io/EJAM/reference/api_run.md)
...
- Added article (vignette) about [speed – how long it takes to analyze
  thousands of
  sites](https://ejanalysis.github.io/EJAM/articles/dev-speed.html)
...
- [`ejamit()`](https://ejanalysis.github.io/EJAM/reference/ejamit.md) no
  longer will ask to confirm zero radius in shapefile case
- Drafted changes in
...
- Drafted changes to draft API code to provide more endpoints, start
  work on POST vs just GET, added
  [`api_run()`](https://ejanalysis.github.io/EJAM/reference/api_run.md)
...
- [ejanalysis.org/ejamdocs](https://www.ejanalysis.org/ejamdocs) directs
  ...
  - [What is
    EJAM?](https://ejanalysis.github.io/EJAM/articles/whatis.html) is an
    overview of what EJAM can do.
  - [Accessing the Web
    App](https://ejanalysis.github.io/EJAM/articles/webapp.html) is
    about the web app.
...
- Collected copies of old user guides to inform a new one that could be
  ...
  examples](https://github.com/ejanalysis/EJAM/tree/EJAM-v2.32.6/data-raw/user-guides)
  that [will be
  here](https://github.com/ejanalysis/EJAM/tree/main/data-raw/user-guides)
...
- [GitHub issues now can be submitted
  here](https://github.com/ejanalysis/EJAM/issues)
...
|----|----|----|----|
| EJAM Report | Report | [`url_ejamapi()`](https://ejanalysis.github.io/EJAM/reference/url_ejamapi.md) | sitepoints (or lat,lon) or shapefile or fips |
| EJSCREEN Map | EJSCREEN | [`url_ejscreenmap()`](https://ejanalysis.github.io/EJAM/reference/url_ejscreenmap.md) | sitepoints (or lat,lon) or shapefile or fips |
| EnviroMapper Report | EnviroMapper | [`url_enviromapper()`](https://ejanalysis.github.io/EJAM/reference/url_enviromapper.md) | sitepoints (or lat,lon) or shapefile or fips |
| ECHO Report | ECHO | [`url_echo_facility()`](https://ejanalysis.github.io/EJAM/reference/url_echo_facility.md) | regid |
| FRS Report | FRS | [`url_frs_facility()`](https://ejanalysis.github.io/EJAM/reference/url_frs_facility.md) | regid |
| County Health Report | County | [`url_county_health()`](https://ejanalysis.github.io/EJAM/reference/url_county_health.md) | fips |
| State Health Report | State | [`url_state_health()`](https://ejanalysis.github.io/EJAM/reference/url_state_health.md) | fips |
| County Equity Atlas Report | County | [`url_county_equityatlas()`](https://ejanalysis.github.io/EJAM/reference/url_county_equityatlas.md) | fips |
| State Equity Atlas Report | State | [`url_state_equityatlas()`](https://ejanalysis.github.io/EJAM/reference/url_state_equityatlas.md) | fips |
...
- Added
  ...
  [`run_app()`](https://ejanalysis.github.io/EJAM/reference/ejamapp.md)
...
- Drafted a new article with technical details: [Defaults and Custom
  ...
  App](https://ejanalysis.github.io/EJAM/articles/dev-app-settings.html)
...
- New function
  [`url_github_preview()`](https://ejanalysis.github.io/EJAM/reference/url_github_preview.md)
...
- [`fips_county_from_latlon()`](https://ejanalysis.github.io/EJAM/reference/fips_county_from_latlon.md)
  and
...
- **Summary Indexes (aka EJ Indexes)** had some incorrect numbers, so
  ...
  [`?bgej`](https://ejanalysis.github.io/EJAM/reference/bgej.md) dataset
  with correct numbers. (Correct numbers were drawn from the [internet
  archive
...
- [Installation instructions in
  vignette/article](https://ejanalysis.github.io/EJAM/articles/installing.md)
  were redone.
- Articles (aka vignettes) were renamed (titles and file names).
- [README](https://github.com/ejanalysis/EJAM/#readme) mentions
  <https://www.ejanalysis.com> now.
  [`?blockgroupstats`](https://ejanalysis.github.io/EJAM/reference/blockgroupstats.md)
...
- [`plotblocksnearby()`](https://ejanalysis.github.io/EJAM/reference/plotblocksnearby.md)
  rewritten to fix/improve map popups, etc., and a parameter was dropped
...
located at ejanalysis/EJAM, so the package called the v2.32.4 release on
ejanalysis/EJAM is slightly different than the version called the
v2.32.4 release that was released on USEPA/EJAM-open.
...
- unexported draft
  [`read_and_clean_points()`](https://ejanalysis.github.io/EJAM/reference/read_and_clean_points.md)
- unexported draft `ejam2quantiles()`
- removed reference to obsolete testids_registry_id, replaced by
  [`?testinput_regid`](https://ejanalysis.github.io/EJAM/reference/testinput_regid.md)
...
- [`ejamit()`](https://ejanalysis.github.io/EJAM/reference/ejamit.md) in
  interactive mode (RStudio) now lets you select any type of file to
...
- The EJAM R package is available as an open source resource you can
  ...
  - install using the [installation
    instructions](https://ejanalysis.github.io/EJAM/articles/installing.md)
