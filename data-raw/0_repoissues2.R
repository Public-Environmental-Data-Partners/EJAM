...
#'
#' repname = "OWNERNAME/REPONAME" # e.g.,  EJAM::url_package()
#'
#' x1 = repoissues(repname, savedetails = TRUE, savebasics = TRUE, folder = "~/../Downloads")
#'
#' x2 = repoissues2(repname, savedetails = TRUE, savebasics = TRUE, folder = "~/../Downloads")
#'
