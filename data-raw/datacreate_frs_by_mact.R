...
# Old script to download and clean tables of facilities by MACT subpart

# required 1st updating
#   frs_by_programid

# created  frs_by_mact
# created  mact_table
# created  epa_programs

message("datacreate_frs_by_mact() IS NOT WORKING - THE CODE WAS OUT OF ORDER SO THE SCRIPT DOES NOT WORK -
     APPEARS TO BE REPLACED BY 'datacreate_frs_.R' which uses frs_update_datasets()   ")
