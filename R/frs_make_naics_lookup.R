...
#' @import data.table
#' @return table in [data.table](https://r-datatable.com) format with columns NAICS, REGISTRY_ID, etc.
...
#   head(x, 20)
  ...
  # Obsolete: publish frs_by_naics.arrow; do not save as package .rda data.
