...
#'   Variable names can be from column of map_headernames called rname, e.g.
...
xls_varname2vartype <- function(varname, varnameinfo) {
  ...
  varnameinfo[match(varname, varnameinfo[ , 'rname'], nomatch = NA), 'jsondoc_vartype']
}
################################################################################## #
...
#' helper function - for color coding excel sheet columns - NOT USED (but could be)
#'
