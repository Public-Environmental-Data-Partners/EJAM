...
#' EJAM:::round2nearest_n(1534, 100); round2nearest_n(9161, 100)
#' round(1534, -2); round(9161, -2)
#'
#' # round to nearest 10
#' EJAM:::round2nearest_n(1534, 10); round2nearest_n(9161, 10)
#' round(1534, -1); round(9161, -1)
#'
#' # When n < 1, it easy to just use round()
#' # round to 0 decimals
#' EJAM:::round2nearest_n(15.3, 1); round2nearest_n(91.61, 1)
#' round(15.3, 0); round(91.61, 0)
#'
#' # round to 1 decimal
#' EJAM:::round2nearest_n(0.153, 0.1); round2nearest_n(0.9161, 0.1)
