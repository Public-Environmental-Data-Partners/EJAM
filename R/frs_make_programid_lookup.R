...
#' @param x [frs] table in [data.table](https://r-datatable.com) format from [frs_get()]
...
#'
#' @import data.table
#' @return table in [data.table](https://r-datatable.com) format with columns lat, lon, REGISTRY_ID, program, pgm_sys_id
