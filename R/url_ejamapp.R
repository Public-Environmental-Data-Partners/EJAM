...
#'   `url_ejamapp_alias`, currently `https://ejam.ejanalysis.com` — equivalently
...
url_ejamapp <- function(sitepoints = NULL, lat = NULL, lon = NULL,
                        ...
                        baseurl = url_package("ejamapp", desc_or_alias = "alias"), # the branded, query-preserving alias (see DESCRIPTION url_ejamapp_alias)
