...
#'
#'   It provides metadata or information about each variable (indicator), such as the following:
#'
#'   - names as used in the R code ("rname"), which is the "canonical" name for each variable, and is used in the R code and in the EJAM API
...
#'   - names as used in EJSCREEN-specific files/code/app (`ejscreen_indicator`)
#'   - row-type flags that indicate if a variable is in various categories or types
#'   - main category of variable or "varlist" for purposes of grouping similar ones like those in names_e, names_d, or names_d_pctile
