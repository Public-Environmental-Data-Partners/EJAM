...
# from_varlist_add
{
  from_varlist_add =  sort(  c(
    ...
    "names_age", "names_age_count", "names_climate", "names_climate_avg",
    "names_climate_pctile", "names_climate_state_avg", "names_climate_state_pctile",
    "names_community", "names_community_count", "names_countabove",
    "names_criticalservice", "names_criticalservice_avg", "names_criticalservice_count",
    "names_criticalservice_pctile", "names_criticalservice_state_avg",
    "names_criticalservice_state_pctile", "names_d", "names_d_avg",
    "names_d_count", "names_d_demogindexstate", "names_d_extra",
    "names_d_extra_count", "names_d_language", "names_d_language_count",
    "names_d_languageli", "names_d_languageli_count", "names_d_other_count",
...
# from_datasets
{
  from_datasets  <- c(
    ...
    "naics_counts", "naicstable", "names_age", "names_age_count",
    "names_all", "names_all_r", "names_climate", "names_climate_avg",
    "names_climate_pctile", "names_climate_state_avg", "names_climate_state_pctile",
    "names_community", "names_community_count", "names_countabove",
    "names_criticalservice", "names_criticalservice_avg", "names_criticalservice_pctile",
    "names_criticalservice_state_avg", "names_criticalservice_state_pctile",
    "names_d", "names_d_avg", "names_d_count", "names_d_demogindexstate",
    "names_d_extra", "names_d_extra_count", "names_d_language", "names_d_language_count",
    "names_d_languageli", "names_d_languageli_count", "names_d_other_count",
    "names_d_pctile", "names_d_ratio_to_avg", "names_d_ratio_to_state_avg",
    "names_d_state_avg", "names_d_state_pctile", "names_d_subgroups",
    "names_d_subgroups_alone", "names_d_subgroups_alone_avg", "names_d_subgroups_alone_count",
...
# from_check_var
{
  from_check_var =  c(
    ...
    "ejam_uniq_id", "ejscreen_version_global", "eparegion", "estimate",
