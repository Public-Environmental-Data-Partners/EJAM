...
#' @param x table in [data.table](https://r-datatable.com) format [frs] from [frs_clean_sic()]
#' @import data.table
#' @return table in [data.table](https://r-datatable.com) format with lat, lon, REGISTRY_ID, SIC columns
...
frs_make_sic_lookup <- function(x) {
  ...
  # Obsolete: publish frs_by_sic.arrow; do not save as package .rda data.
