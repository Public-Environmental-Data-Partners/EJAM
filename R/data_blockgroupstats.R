...
#'  - [Full list of indicators, with definitions](https://github.com/ejanalysis/EJAM/blob/development/data-raw/EJSCREEN_archived_pages/ejscreen_sources_plaintext.md){target="_blank"}. Full webpage is also available [as archived](https://web.archive.org/web/20250123161322/https://www.epa.gov/ejscreen/ejscreen-map-descriptions){target="_blank"}.
