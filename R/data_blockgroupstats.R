...
#'
#'   - Datasets stored within the EJAM package (.rda files): [Documentation](`r paste0(EJAM:::repo_from_desc(get_full_url = T, domain = "github.io"), "/reference/index.html#datasets-with-indicators-raw-data-means-percentiles-")`) and [access to data files](https://github.com/ejanalysis/EJAM/tree/main/data)
#'
#'   - Datasets used by EJAM but stored separately (large .arrow files): [Documentation](https://ejanalysis.github.io/EJAM/reference/index.html#datasets-with-indicators-raw-data-means-percentiles-)
#'   and [access to data files](`r paste0(EJAM:::repo_from_desc(get_full_url = T, domain = "github.io"), "/tree/main/data")`)
#'
